...
func NewFixHandler(fixInfo *metav1.FixInfo) (*FixHandler, error) {
	...
	if reportObj.Metadata.ScanMetadata.ScanningTarget == 0 && len(reportObj.Results) == 0 {
		return nil, fmt.Errorf("invalid report file: not a valid kubescape scan report. Please provide a JSON file generated by 'kubescape scan --format json'")
	}
